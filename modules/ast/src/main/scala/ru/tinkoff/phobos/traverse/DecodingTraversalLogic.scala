...
trait DecodingTraversalLogic[Acc, Result] {
  ...
  /** Updates accumulator with found text
    ...
    *   - accumulator
    * @param elemName
    *   - name some XML element
    * @param text
    *   - decoded XML text (see [[XmlLeaf]] for details)
    * @return
    *   - updated accumulator
    */
  ...
  /** Updates accumulator with intermediate traversal result
    ...
    *   - accumulator
    * @param field
    *   - name of decoded XML node
    * @param intermediateResult
    *   - result of recursive traversal
    * @return
    *   - updated accumulator
    */
